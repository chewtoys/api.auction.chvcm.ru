...
describe("GET /attachments/:id", () => {
  ...
  it("Bad Request 400 - wrong id (wrong symbols)", async () => {
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/id2`)
  ...
  it("Bad Request 400 - wrong id (on less)", async () => {
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/0`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .expect(400, {
        code: PgBigSerialUnitCodes.WRONG_PG_BIGSERIAL,
  ...
  it("Bad Request 400 - wrong id (on more)", async () => {
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/9223372036854775808`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .expect(400, {
        code: PgBigSerialUnitCodes.WRONG_PG_BIGSERIAL,
  ...
  it("Bad Request 400 - wrong limit (wrong symbols)", async () => {
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/2`)
      .query({
        limit: "infinity",
      })
      .set("Authorization", `Bearer ${tokenEntity}`)
  ...
  it("Unauthorized 401 - entity not found", async () => {
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/999`)
      .set("Authorization", `Bearer ${await Jwt.signUser({
        id: "999",
  ...
  it("correct for entity and employee - zero limit", async () => {
    await supertest(Web.instance.app).put(`${Const.API_MOUNT_POINT}/attachments/2/files_3.zip`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .set("Content-Type", "application/octet-stream")
      .expect(204);
  ...
  it("correct for entity and employee - all files without pagination", async () => {
    ...
    await supertest(Web.instance.app).put(`${Const.API_MOUNT_POINT}/attachments/2/files_20.zip`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .set("Content-Type", "application/octet-stream")
      .expect(204);

    await supertest(Web.instance.app).put(`${Const.API_MOUNT_POINT}/attachments/2/files_2.zip`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .set("Content-Type", "application/octet-stream")
      .expect(204);

    await supertest(Web.instance.app).put(`${Const.API_MOUNT_POINT}/attachments/2/files_10.zip`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .set("Content-Type", "application/octet-stream")
      .expect(204);

    await supertest(Web.instance.app).put(`${Const.API_MOUNT_POINT}/attachments/2/files_1.zip`)
      .set("Authorization", `Bearer ${tokenEntity}`)
      .set("Content-Type", "application/octet-stream")
      .expect(204);
    ...
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/2`)
      ...
      .set("Content-Type", "application/octet-stream")
      .expect(200, {
        attachments: ["files_1.zip", "files_10.zip", "files_2.zip", "files_20.zip", "files_3.zip"],
      });
  ...
  it("correct for entity and employee - all files with pagination", async () => {
    ...
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/2`)
      ...
      .set("Content-Type", "application/octet-stream")
      .expect(200, {
        attachments: ["files_1.zip", "files_10.zip", "files_2.zip"],
    ...
    await supertest(Web.instance.app).get(`${Const.API_MOUNT_POINT}/attachments/2`)
      ...
      .set("Content-Type", "application/octet-stream")
      .expect(200, {
        attachments: ["files_20.zip", "files_3.zip"],
      });
